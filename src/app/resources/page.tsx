            ...
            {tr.items.map(item => (
              ...
              >
                <div className="flex items-start gap-4 mb-4">
                  ...
                  <h3 className="font-display text-lg" style={{ color: 'var(--ivory)' }}>{item.label}</h3>
                </div>
                <p className="text-sm font-ui leading-relaxed flex-1" style={{ color: 'var(--mist)' }}>{item.desc}</p>
